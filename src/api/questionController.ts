...
export async function addQuestionUsingPost(
  ...
  return request<API.ResultApiLong_>("/api/question/add", {
    method: "POST",
    headers: {
...
export async function deleteQuestionUsingPost(
  ...
  return request<API.ResultApiBoolean_>("/api/question/delete", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function editQuestionUsingPost(
  ...
  return request<API.ResultApiBoolean_>("/api/question/edit", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function getQuestionVoByIdUsingGet(
  ...
  return request<API.ResultApiQuestionVO_>("/api/question/get/vo", {
    method: "GET",
    params: {
      ...params,
    },
...
export async function listQuestionByPageUsingPost(
  ...
  return request<API.ResultApiPageQuestion_>("/api/question/list/page", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function listQuestionVoByPageUsingPost(
  ...
  return request<API.ResultApiPageQuestionVO_>("/api/question/list/page/vo", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function listMyQuestionVoByPageUsingPost(
  ...
  return request<API.ResultApiPageQuestionVO_>(
...
export async function updateQuestionUsingPost(
  ...
  return request<API.ResultApiBoolean_>("/api/question/update", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
