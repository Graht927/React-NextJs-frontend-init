...
export async function addQuestionBankUsingPost(
  ...
  return request<API.ResultApiLong_>("/api/questionbank/add", {
    method: "POST",
    headers: {
...
export async function deleteQuestionBankUsingPost(
  ...
  return request<API.ResultApiBoolean_>("/api/questionbank/delete", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function editQuestionBankUsingPost(
  ...
  return request<API.ResultApiBoolean_>("/api/questionbank/edit", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function getQuestionBankVoByIdUsingGet(
  ...
  return request<API.ResultApiQuestionBankVO_>("/api/questionbank/get/vo", {
    method: "GET",
    params: {
      ...params,
    },
...
export async function listQuestionBankByPageUsingPost(
  ...
  return request<API.ResultApiPageQuestionBank_>(
...
export async function listQuestionBankVoByPageUsingPost(
  ...
  return request<API.ResultApiPageQuestionBankVO_>(
...
export async function updateQuestionBankUsingPost(
  ...
  return request<API.ResultApiBoolean_>("/api/questionbank/update", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
